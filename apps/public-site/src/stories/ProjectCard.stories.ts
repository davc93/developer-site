...
import { type ProjectCardProps, createProjectCard } from '../components/molecules/ProjectCard'
...
export const Large: Story = {
  args: {
    ...
    shortDescription:
      'My personal website and their different apps My personal website and their different apps My personal website and their different apps',
    published: true,
    slug: 'davc93',
    labels: [
      {
